...
env.Append(CCFLAGS=["-g3", "-Werror", "-Wextra", "-Wall", "-Wshadow", "-Wfloat-equal", "-Wpointer-arith", "-Wcast-align", "-Wstrict-prototypes", "-Wstrict-overflow=2", "-Wwrite-strings", "-Wcast-qual", "-Wswitch-default", "-Wswitch-enum", "-Wconversion", "-Wunreachable-code", "-Wformat=2", "-D_REENTRANT"])
